...
class Input_Parse:
    ...
    def apriltag_callback(self,msg):
        if msg.detections:
            ...
            for at in msg.detections:
                ...
                self.at_tranf = self.at_transf.dot(self.position_landmark_inworld_matrix[self.selected_id])
    ...
    def compute_input_parse(self):
        ...
        if self.u is not None and at_transf is not None and ori is not None:
            ...
            # print('ux',linear_velocity,'wz,',angular_velocity )
    ...
    #     # to get the position of the apriltags in the world
